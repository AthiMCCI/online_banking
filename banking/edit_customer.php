...
$sql1 = "SELECT * FROM passbook".$_SESSION['cust_id']." WHERE trans_id=(SELECT MAX(trans_id) FROM passbook".$_SESSION['cust_id'].")";
    ...
    <form class="add_customer_form" action="edit_customer_action.php" method="post">
        ...
        <div class="flex-container">
            ...
            <div class="flex-container">
                ...
                <div  class=container>
                    <select name="branch">
                        <option value="Tirunelveli" <?php if ($branch == 'Tirunelveli') {?> selected="selected" <?php }?>>Tirunelveli</option>
                        <option value="cheenai" <?php if ($branch == 'cheenai') {?> selected="selected" <?php }?>>cheenai</option>
                        <option value="Kovilpatti" <?php if ($branch == 'Kovilpatti') {?> selected="selected" <?php }?>>Kovilpatti</option>
                        <option value="VADAPALANI" <?php if ($branch == 'Vadapalani') {?> selected="selected" <?php }?>>VADAPALANI</option>
                        <option value="ASOKNAGAR" <?php if ($branch == 'ASOKENAGAR') {?> selected="selected" <?php }?>>ASOKENAGAR</option>
                    </select>
                </div>
            </div>
            <div class="flex-container">
