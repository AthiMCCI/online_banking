    ...
    <body>
        <form class="add_customer_form" action="customer_add_action.php" method="post">
            ...
            <div class="flex-container">        
                ...
                <div  class=container>
                    <select name="branch">
                        <option value="SHIVAMOGA">Tirunelveli</option>
                        <option value="BANGALORE">chennia</option>
                        <option value="CHITRADURGA">kovilpatti</option>
                        <option value="BHADRAVATHI">Asoke Nagar</option>   
                        <option value="MYSORE">Vadapalani</option>
                    </select>
                </div>
            </div>
            <div class="flex-container">
