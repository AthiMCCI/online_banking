...
<body>
    <form class="add_customer_form" action="customer_profile_action.php" method="post">
        ...
        <div class="flex-container">
            <div class=container>
                <label>Account No : <label id="info_label">
            ...
            <div class="flex-container">
                <div  class=container>
                    <label>Phone No. : <label id="info_label">
                ...
                <div class="flex-container">
                    <div class=container>
                        <label>Bank Branch :
                            <label id="info_label">
                                <?php
                                if ($branch == "SHIVAMOGA") {echo "SHIVAMOGA";}
                                elseif ($branch == "BANGALORE")
                                {echo "BANGALORE";}
                                elseif ($branch == "CHIRADURGA") {echo "CHITRADURGA";}
                                elseif ($branch == "BHADRAVATHI") 
                                {echo "BHADRAVATHI";}
                                elseif ($branch == "MYSORE") {echo "MYSORE";}
                                ?>
                                </label>
                        </label>
                    </div>
