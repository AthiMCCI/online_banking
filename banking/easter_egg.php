...
<body>
    <div id="eEgg_modal" class="modal-eEgg">
        <div class="modal-content-eEgg">
            ...
            <h3>They float,' it growled, 'they float, Georgie, and whenyou’re down here with me, you’ll float, too–'</h3>
        </div>
...
function eEgg_func()
{
    ...
    if (count > 7 && !eEgg_flag)
    {
        ...
        setInterval(function()
        {
            ...
            document.getElementById("footer").innerHTML ="Going back in "+ seconds + "s...";
        }, 1000);
    }
}
</script>